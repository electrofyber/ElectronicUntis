 ...
 * @property element The element corresponding to this user. Used for personal timetable. Usually [ElementType.STUDENT]. `null` if anonymous or no element is associated with this user.
 */
data class User(
	val id: Long,
	val name: String,
