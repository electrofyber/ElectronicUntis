...
//import com.sapuseven.untis.feature.infocenter.ErrorPreviewParameterProvider
	...
	MessageBubble(
		...
		icon = {
			Icon(
				...
				contentDescription = stringResource(id = R.string.feature_infocenter_error)
			)
		},
		messageText = R.string.feature_infocenter_errormessagedictionary_generic,
