...
fun SettingsCategoryAbout(navController: NavController) {
	...
	/*Preference(
		...
		summary = {
			Text(
				stringResource(
					R.string.feature_settings_preference_info_app_version_desc,
	...
	PreferenceGroup(stringResource(id = R.string.feature_settings_preference_info_general)) {
		...
		Preference(
			title = { Text(stringResource(R.string.feature_settings_preference_info_license)) },
			summary = { Text(stringResource(R.string.feature_settings_preference_info_license_desc)) },
			onClick = {
		...
		Preference(
			title = { Text(stringResource(R.string.feature_settings_preference_info_contributors)) },
			summary = { Text(stringResource(R.string.feature_settings_preference_info_contributors_desc)) },
			onClick = {
				...
				confirmButton = {
					FlowRow(
						...
						TextButton(
							...
							Text(text = stringResource(id = R.string.feature_settings_preference_info_privacy_policy))
						}
						...
						Row(
							...
							TextButton(
								...
								Text(text = stringResource(id = com.sapuseven.untis.core.ui.R.string.all_cancel))
							}

							TextButton(
								onClick = {
									externalSourceDialog.value = false
									navController.navigate(SettingsRoute.About.Contributors)
								}
							) {
								Text(text = stringResource(id = com.sapuseven.untis.core.ui.R.string.all_ok))
							}
						}
					}
				},
				title = {
					Text(text = stringResource(id = R.string.feature_settings_preference_info_privacy))
				},
				text = {
					Text(stringResource(id = R.string.feature_settings_preference_info_privacy_desc))
				}
			)
		}

		Preference(
			title = { Text(stringResource(R.string.feature_settings_preference_info_libraries)) },
			summary = { Text(stringResource(R.string.feature_settings_preference_info_libraries_desc)) },
			onClick = { navController.navigate(SettingsRoute.About.Libraries) },
			leadingContent = {
				Icon(
