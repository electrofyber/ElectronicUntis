...
private fun PermissionInfoMessage(
	...
	AnimatedVisibility(
		...
		MessageBubble(
			...
			icon = {
				/*Icon(
					painter = painterResource(id = com.sapuseven.untis.core.ui.R.drawable.all_warning),
					contentDescription = stringResource(id = com.sapuseven.untis.core.ui.R.string.all_warning)
				)*/
			},
...
fun NotificationsInfoMessage(
	...
	/*PermissionInfoMessage(
		...
		requestPermissionIntent = Intent(ACTION_APP_NOTIFICATION_SETTINGS).putExtra(EXTRA_APP_PACKAGE, BuildConfig.APPLICATION_ID), TODO
		visible = visible,
		primaryText = R.string.feature_settings_preference_notifications_unavailable,
		secondaryText = stringResource(R.string.feature_settings_preference_notifications_unavailable_desc, stringResource(R.string.feature_settings_app_name))
	)*/
}
